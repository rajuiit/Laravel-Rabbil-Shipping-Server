...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <!-- Sidebar -->
    <ul style="background-color: #f8f9fc;" class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion"
      id="accordionSidebar">
      ...
      <!-- Canceled Charts -->
      <li class="nav-item">
        <a class="nav-link" href="{{ route('order.cancel') }}">
          <i class="fas fa-fw fa-chart-area"></i>
